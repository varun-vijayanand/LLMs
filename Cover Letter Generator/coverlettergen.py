...
ai.api_key = "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"
...
with st.form(key='my_form_to_submit'):    
    ...
    contact_person = st.text_input("Who are you emailing? ",)
    your_name = st.text_input("What is your name? ",)
    personal_exp = st.text_input("I have experience in...",)
